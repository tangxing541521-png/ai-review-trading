...
export const api = {
  ...
  marketHub: () => request('/market-hub'),
  dataCenterStatus: () => request('/data-center/status'),
  tradingPlan: () => request('/trading-plan'),
  tradeScript: () => request('/trade-script'),
  preMarket: () => request('/pre-market'),
  auctionAi: () => request('/auction-ai'),
  realtimeAi: () => request('/realtime-ai'),
  aiDecision: () => request('/ai-decision'),
  traderAgent: () => request('/trader-agent'),
  runPipeline: () => request('/run-pipeline', { method: 'POST' }),
  jobStatus: (jobId) => request(`/job-status/${jobId}`),
